...
#Preview("BeneficiaryPickerView - Empty") {
    struct PreviewWrapper: View {
        ...
        var body: some View {
            VStack(spacing: 20) {
                ...
                Text("Selected: \(selectedBeneficiary?.name ?? "None")")
                    .font(.caption)
            }
            .padding()
        }
...
#Preview("BeneficiaryPickerView - With Beneficiaries") {
    struct PreviewWrapper: View {
        @State private var selectedBeneficiary: Beneficiary?
...
#Preview("BeneficiaryPickerView - Pre-selected") {
    struct PreviewWrapper: View {
        @State private var selectedBeneficiary: Beneficiary? = Beneficiary(
            id: "BEN001",
            name: "John Smith",
            accountNumber: "1234567890",
            iban: nil,
