...
#Preview("AccountSummaryCard - Checking") {
    AccountSummaryCard(
        account: Account(
            id: "ACC001",
...
#Preview("AccountSummaryCard - Savings Hidden") {
    AccountSummaryCard(
        account: Account(
            id: "ACC002",
...
#Preview("AccountSummaryCard - With Transfer") {
    AccountSummaryCard(
        account: Account(
            id: "ACC001",
            accountNumber: "1234567890",
...
#Preview("AccountSummaryCard - Multiple") {
